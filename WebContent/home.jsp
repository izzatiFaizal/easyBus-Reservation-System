			            ...
			            <div class="card-body">
			              ...
			              <div class="masthead" style="background-image: url(img/watercolorbg.jpg); border-radius : 25px; margin:auto ; height:300px; width: 1000px; border: 3px solid white;">
				              <div class="intro-text">
				                <div class="intro-lead-in">
				                   ...
				                   <center><h1><font face="Forte" color="#FFA500">Glad you are here <%= session.getAttribute("currentSessionUser") %></font></h1></center>
				                </div>
				              </div>
			              </div><p>
			              <div class="table-responsive">
	                      	...
	                      	<table align = "center" cellpadding="4" cellspacing="3">
	                              <tr>
	                                  <th>Name: </th>
	                                  <th><input type="text" class="form-control form-control-user" name="name" value="<%= session.getAttribute("currentSessionUser") %>" readonly/></th>
	                             </tr>
	                             <tr>
	                                  <th>IC Number:</th>
	                                  <th><input type="text" class="form-control form-control-user" name="ICNumber" value="<%= session.getAttribute("ICNumber") %>" readonly/></th>
	                             </tr>
	                             <tr>
	                                  <th>Phone Number:&nbsp&nbsp&nbsp </th>
	                                  <th><input type="text" class="form-control form-control-user" name="phoneNo" value="<%= session.getAttribute("phoneNo") %>" readonly/></th>
	                             </tr>
	                             <tr>
	                                 <th>Email: </th>
	                                 <th><input type="text" class="form-control form-control-user" name="email" value="<%= session.getAttribute("email") %>" readonly/></th>
	                             </tr>
	                         </table>
                         </div></p>
			           </div>
