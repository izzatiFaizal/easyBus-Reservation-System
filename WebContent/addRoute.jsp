        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add New Route</h1><hr>
                    <p class="mb-4"></p>

                    <!-- List of routes -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Route form</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="AddRouteController" method="post">
                                <table align = "center" cellpadding="4" cellspacing="3">	
	                                        <tr>
	                                            <th>From:&nbsp&nbsp&nbsp</th>
	                                            <th><input type="text" class="form-control form-control-user" name="fromWhere"></th>
	                                        </tr>
	                                        <tr>
	                                            <th>To: </th>
	                                            <th><input type="text" class="form-control form-control-user" name="toWhere"></th>
	                                        </tr>
	                                        <tr>
	                                            <th>Price: </th>
	                                            <th><input type="text" class="form-control form-control-user" name="ticketPrice"></th>
	                                        </tr>
	                                        <tr>
	                                            <td colspan = "2" align = "center">
	                                            <input type="submit" name="Submit" class="button button2">
	                                        	<button class="button button3" type="button" onclick="location.href='admin.jsp'">Cancel</button>
	                                        	</td>
	                                        </tr>
	                                    </table>
	                        </form>
