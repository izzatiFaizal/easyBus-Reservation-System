        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
	                <!-- Page Heading -->
	                    <h1 class="h3 mb-2 text-gray-800">Update Routes</h1><hr>
	                    <p class="mb-4"></p>
	                        ...
	                        <div class="card-body">
	                            ...
	                            <form action="UpdateRouteController" method="POST">
	                                    <table align = "center" cellpadding="4" cellspacing="3">
	                                        ...
	                                        <tr>
	                                            <th>From: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="fromWhere" value="<c:out value="${route.fromWhere}"/>"></td>
	                                        </tr>
	                                        <tr>
	                                            <th>To: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="toWhere" value="<c:out value="${route.toWhere}"/>"></td>
	                                        </tr>
	                                        <tr>
	                                            <th>Ticket Price: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="ticketPrice" value="<c:out value="${route.ticketPrice}"/>"></td>
	                                        </tr>
		                                    <tr>
		                                        <td colspan = "2" align = "center">
		                                        <input type="submit" name="Update" class="button button2">
		                                        <button class="button button3" type="button" onclick="location.href='route.jsp'">Cancel</button>
		                                        </td>
		                                    </tr>
	                                    </table>
	                            </form>
