					...
					<div class="card">
			            <div class="card-body">
				              ...
				              <div class="intro-text">
				                <div class="intro-lead-in">
				                   <div class="image-container"><br>
				                     <img src="img/thanks.png" style="margin-left: 280px" width="400px" height="150px" alt="welcome"><br><br>
				                   </div>
			              ...
			              <div class="table-responsive">
	                      	<center><p><a href ="ViewReceiptController?action=view&passID=<%= session.getAttribute("passID") %>" class="button button2">View Booking Details</a>
	                                </center>
                         </div></p>
			           </div>
                </div>
