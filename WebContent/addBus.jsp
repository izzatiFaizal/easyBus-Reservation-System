        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add New Bus</h1><hr>
                    <p class="mb-4"></p>

                    <!-- List of routes -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Bus form</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="AddBusController" method="post">
                                <table align = "center" cellpadding="4" cellspacing="3">
	                                    	<tr>
	                                            <th>Bus Plate No:&nbsp&nbsp&nbsp</th>
	                                            <th><input type="text" class="form-control form-control-user" name="plateNo"></th>
	                                        </tr>
	                                        <tr>
	                                            <th>Bus Name:</th>
	                                            <th><input type="text" class="form-control form-control-user" name="busName"></th>
	                                        </tr>
	                                        <tr>
	                                            <th>Route ID: </th>
