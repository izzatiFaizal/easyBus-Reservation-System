        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
	                <!-- Page Heading -->
	                    <h1 class="h3 mb-2 text-gray-800">View Bus</h1><hr>
	                    <p class="mb-4"></p>
	                        ...
	                        <div class="card-body">
                                ...
                                <form action="UpdateBusController" method="POST">   
                                    <table align = "center" cellpadding="4" cellspacing="3">
                                        ...
                                        <tr>
                                            <th>Plate No:</th>
                                            <th><input type="text" class="form-control form-control-user" name="plateNo" value="<c:out value="${bus.plateNo}"/>" readonly></th>
                                        </tr>
                                        <tr>
                                            <th>Bus Name:&nbsp&nbsp&nbsp</th>
                                            <th><input type="text" class="form-control form-control-user" name="busName" value="<c:out value="${bus.busName}"/>" readonly></th>
                                        </tr>
                                        <tr>
                                            <th>Route ID: </th>
                                            <th><input type="text" class="form-control form-control-user" name="busName" value="<c:out value="${bus.routeID}"/>" readonly></th>
                                        </tr>
                                        <tr>
                                            <th>Scehdule: </th>
                                            <th><input type="text" class="form-control form-control-user" name="busName" value="<c:out value="${bus.ticketNo}"/>" readonly></th>
                                        </tr>
                                        <tr>
	                                        <td colspan = "2" align = "center">
		                                        <button class="button button2" type="button" onclick="location.href='buses.jsp'">Back</button>
		                                    </td>
	                                    </tr>
                                    </table>
                                </form>
