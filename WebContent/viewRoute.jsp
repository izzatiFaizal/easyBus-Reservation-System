        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
	                <!-- Page Heading -->
	                    <h1 class="h3 mb-2 text-gray-800">View Route</h1><hr>
	                    <p class="mb-4"></p>
	                    ...
	                    <div class="card shadow mb-4">
	                        ...
	                        <div class="card-body">
	                            ...
	                            <form action="UpdateRouteController" method="POST">
	                                    <table align = "center" cellpadding="4" cellspacing="3">
	                                    	<tr>
	                                            <th>Route ID:&nbsp&nbsp&nbsp </th>
	                                            <td><input type="text" class="form-control form-control-user" name="routeID" value="<c:out value="${route.routeID}"/>" readonly></td>
	                                        </tr>
	                                        <tr>
	                                            <th>From: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="fromWhere" value="<c:out value="${route.fromWhere}"/>"readonly></td>
	                                        </tr>
	                                        <tr>
	                                            <th>To: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="toWhere" value="<c:out value="${route.toWhere}"/>"readonly></td>
	                                        </tr>
	                                        <tr>
	                                            <th>Ticket Price: </th>
	                                            <td><input type="text" class="form-control form-control-user" name="ticketPrice" value="<c:out value="${route.ticketPrice}"/>"readonly></td>
	                                        </tr>
		                                    <tr>
		                                        <td colspan = "2" align = "center">
		                                        <button class="button button2" type="button" onclick="location.href='route.jsp'">Back</button>
		                                        </td>
		                                    </tr>
	                                    </table>
	                            </form>
